...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1">&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log">&nbsp;Signout</button></a></span>';
}?>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0"><b>Quiz</b></a>
    </div>
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        </li><li class="pull-right"> <a href="logout.php?q=account.php">&nbsp;&nbsp;&nbsp;&nbsp;Signout</a></li>
...
if($rowcount == 0){
	...
	<td><b><a href="account.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32">&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
